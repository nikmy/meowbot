...
func (m *MockrepoClient) Make(lvl txn.Model) txn.Txn {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Make", lvl)
	ret0, _ := ret[0].(txn.Txn)
	return ret0
}

// Make indicates an expected call of Make.
func (mr *MockrepoClientMockRecorder) Make(lvl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Make", reflect.TypeOf((*MockrepoClient)(nil).Make), lvl)
}
